...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
     ...
     * to the data.
     */
    val playlist: LiveData<List<DevByteVideo>> = videosRepository.videosFlow.asLiveData(Dispatchers.IO)
    ...
    private fun refreshDataFromRepository() = viewModelScope.launch {
        try {
            videosRepository.videosFlow
                .catch { _eventNetworkError.value = true }
    ...
    /**
     * Refresh data from the network. Use a coroutine launch to run in a
     * background thread.
     */
